...
subR();
    ...
    cart.items.forEach(function(item, index) {
        ...
        const productTitle = '<div class="ajax-cart-item__title">' + item.product_title + '<span class="ajax-cart-suv ' + item.variant_title +'">' + item.variant_title + '</span></div>';
       ...
       const concatProductInfo = '<div class="ajax-cart-item__single" data-line="' + Number(index + 1) + '">'+ productRemove + productImage + '<div class="rig-img"><div class="grid-tit">' + productTitle  + '</div><div class="qunt-grid">'+ productQuantity +  productPrice + '</div></div></div>';
