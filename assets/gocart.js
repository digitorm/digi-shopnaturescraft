...
class GoCart {
    ...
    renderDrawerCart(cart) {
        ...
        <div class="go-cart-item__single" data-line="${Number(index + 1)}">
            ...
            <div class="go-cart-item__price">${Shopify.formatMoney(item.line_price, this.moneyFormat)}</div>
      ...
      `;
        ...
        this.cartDrawerSubTotal.innerHTML = Shopify.formatMoney(cart.total_price, this.moneyFormat);
    ...
    renderMiniCart(cart) {
      ...
      `;
        ...
        this.cartMiniCartSubTotal.innerHTML = Shopify.formatMoney(cart.total_price, this.moneyFormat);
